...
function applyTransformToContainer(container, transform, targets, timeOffset) {
	...
	if(transform.p.a === 0 && transform.a.a === 0) {
		...
		if(transform.a.a !== 0 || transform.a.k[0] !== 0 || transform.a.k[1] !== 0) {
			if (transform.a.a === 1) {
				var animatedProperty = property.createAnimatedProperty(name, 'anchor', transform.a.k, timeOffset);
				targets.push(animatedProperty);
		...
		if(transform.p){
			if(transform.p.a === 0) {
				...
				var animatedProperty = property.createAnimatedProperty(name, 'position', transform.p.k, timeOffset);
				targets.push(animatedProperty);
			}
		}
		if(transform.s.a === 0) {
